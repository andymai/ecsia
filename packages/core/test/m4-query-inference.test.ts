...
// type-check under the project's strict flags. Type-only — drive tsc on it directly.
// Every @ts-expect-error is a real error (the read/write split, has/optional contributions, the arity cap).
